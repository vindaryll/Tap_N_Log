...
// Mask email function to hide parts of the email for security
...
// Check if email is provided in POST
if (isset($_POST['email'])) {
    ...
    if ($email) {
        ...
        $_SESSION['otp_code'] = $otpCode; // Store OTP in session
        ...
        try {
            ...
            $response['message'] = 'OTP code has been sent to ' . $maskedEmail . '! Check your email now.';
        } catch (Exception $e) {
