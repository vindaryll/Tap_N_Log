...
<style>
    ...
    .navbar-nav .nav-link {
        ...
        height: 56px; /* Set a fixed height for all nav links */
    ...
    .navbar-nav .nav-link.active {
        background-color: transparent; /* Remove background color for active state */
        color: red; /* Keep the text color */
    }
        ...
        $('#nav_sendCodeBtn2').click(function () {
            ...
            if (nav_checksendCodeBtn2()){
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    data: { email: nav_current.nav_newEmail},
                    dataType: 'json',
                    success: function (response) {
                        if (response.success) {
                            ...
                            if (response.success) {
                                ...
                                if (confirm("OTP verified successfully! Do you want to update your email address?")) {
                                    ...
                                    $.ajax({
                                        ...
                                        type: 'POST',
                                        data: { nav_newEmail: nav_newEmail },
                                        dataType: 'json',
