        ...
        <div class="container-fluid row col-sm-12 px-2">
            ...
            <div class="container-fluid col-sm-12 mt-sm-0 mt-4 p-0">
                <div class="container mt-3 p-0">
                    <h2 class="page-title text-center w-100">ON THE JOB TRAINEES RFID PROFILES</h2>
                    <div class="mb-3">
    ...
    <div class="modal fade" id="sortModal" tabindex="-1" aria-labelledby="sortModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        <label class="form-label"><strong>SORT BY DATE APPROVED</strong></label>
                        <div>
                    ...
                    <div class="container d-flex justify-content-around align-items-center p-0">
                        <div class="row w-100 p-0">
                            ...
                            <div id="revertOriginalBtn_cont" class="col-md-4 col-sm-12 p-1" style="display: none;">
                                <button type="button" class="btn btn-warning btn-custom w-100" id="revertOriginalBtn">REVERT ORIGINAL PICTURE</button>
                            </div>
