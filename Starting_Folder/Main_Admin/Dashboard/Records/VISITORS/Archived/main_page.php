...
<head>
    ...
    <title>Archived Records - Visitors | Main Admin</title>
    <style>
        .input-group {
            position: relative;
        }
        ...
        <div class="container-fluid row col-sm-12 p-0">
            ...
            <div class="container-fluid col-sm-12 mt-sm-0 mt-4 px-2">
                ...
                <div class="container-fluid text-center">
                    <h2 class="page-title text-center w-100">VISITORS ARCHIVED RECORDS</h2>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.view-details-btn', function() {
                ...
                $('#modal_1_phoneNumber').val(phone_number).removeClass('is-invalid');
                $('#modal_1_visitorPass').val(pass);
            ...
            $(document).on('click', '.restore-btn', function() {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: `Do you want to RESTORE the LOG of ${full_name} on ${date}? This action cannot be undone.`,
                    icon: 'question',
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: 'restore_record.php', // The backend script to process the archive
                            type: 'POST',
                            data: {
                                record_id: visitorId
                            },
                            ...
                            error: function(xhr, status, error) {
                                ...
                                Swal.fire({
                                    position: 'top',
                                    title: 'Error!',
                                    text: 'Failed to process restore. Please try again.',
                                    icon: 'error',
                                    timer: 2000,
                                    timerProgressBar: true,
                                    showConfirmButton: false,
