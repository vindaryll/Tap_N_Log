...
if (isset($_SESSION['admin_logged']) || isset($_SESSION['vehicle_guard_logged'])) {
...
<head>
    ...
    <title>Record Post Login Page</title>
...
<body>
                    ...
                    <form id="changePasswordForm">
                        ...
                        <div class="w-100 mt-3">
                            <div class="row d-flex justify-content-center align-items-center">
                                ...
                                <div class="col-6 mb-2">
                                    <button id="submitResetBtn" class="btn btn-primary btn-custom text-uppercase w-100">Submit</button>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // ALERTS AND CONFIRMATION MESSAGE
