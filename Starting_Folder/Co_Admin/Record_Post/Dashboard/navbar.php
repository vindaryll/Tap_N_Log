        ...
        <div class="col-8 d-none d-lg-block">
            <ul class="navbar-nav justify-content-center">
                <li class="nav-item mx-3 d-flex justify-content-center align-items-center">
                    <a href="/TAPNLOG/Starting_Folder/Co_Admin/Record_Post/Dashboard/Attendance_Log/main_page.php" class="nav-link text-center">
                        ATTENDANCE LOG
                    </a>
                </li>
                <li class="nav-item mx-3 d-flex justify-content-center align-items-center">
                    <a href="/TAPNLOG/Starting_Folder/Co_Admin/Record_Post/Dashboard/Records/main_page.php" class="nav-link text-center">
                        RECORDS
                    </a>
                </li>
                <li class="nav-item mx-3 d-flex justify-content-center align-items-center">
                    <a href="/TAPNLOG/Starting_Folder/Co_Admin/Record_Post/Dashboard/Activity_Logs/main_page.php" class="nav-link text-center">
                        ACTIVITY LOGS
                    </a>
                </li>
            </ul>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="navbarOffcanvas" aria-labelledby="navbarOffcanvasLabel">
    ...
    <div class="offcanvas-body">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a href="/TAPNLOG/Starting_Folder/Co_Admin/Record_Post/Dashboard/Attendance_Log/main_page.php" class="nav-link">
                    <i class="bi bi-calendar-check me-2"></i>ATTENDANCE LOG
                </a>
            </li>
            <li class="nav-item">
                <a href="/TAPNLOG/Starting_Folder/Co_Admin/Record_Post/Dashboard/Records/main_page.php" class="nav-link">
                    <i class="bi bi-file-text me-2"></i>RECORDS
                </a>
            </li>
            <li class="nav-item">
                <a href="/TAPNLOG/Starting_Folder/Co_Admin/Record_Post/Dashboard/Activity_Logs/main_page.php" class="nav-link">
