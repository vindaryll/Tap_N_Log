...
// Base SQL query to fetch employees without attendance today and not archived
$query = "
    SELECT 
        ep.employee_id, ep.first_name, ep.last_name, ep.employee_rfid, ep.employee_img, ep.status 
    FROM 
        employees_profile ep 
    LEFT JOIN 
    ...
    WHERE 
        ea.employee_id IS NULL AND ep.status = 'ACTIVE'
";
