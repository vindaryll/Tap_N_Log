...
$query = "
    SELECT 
        ep.ojt_id, ep.first_name, ep.last_name, ep.ojt_rfid, ep.ojt_img, 
        ea.date_att, ea.time_in, ea.ojt_attendance_id
    FROM ojt_profile ep
    INNER JOIN ojt_attendance ea 
        ON ep.ojt_id = ea.ojt_id 
