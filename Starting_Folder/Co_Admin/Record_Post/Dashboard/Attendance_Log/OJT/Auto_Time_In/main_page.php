                    ...
                    <div class="container d-flex justify-content-around align-items-center p-0">
                        <div class="row w-100 p-0">
                            ...
                            <div id="cancel_cont" class="col-md-6 col-sm-12 p-1">
                                <button type="button" class="btn btn-danger custom w-100" id="cancelBtn">CANCEL</button>
                            </div>
                            <div id="saveBtn_cont" class="col-md-6 col-sm-12 p-1">
                                <button type="button" class="btn btn-success custom w-100" id="saveBtn">TIME-IN</button>
                            </div>
                        </div>
                    </div>
                </div>
