...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        // Archive the record
        $archive_query = "UPDATE employees_attendance SET is_archived = TRUE WHERE employee_attendance_id = ?";
