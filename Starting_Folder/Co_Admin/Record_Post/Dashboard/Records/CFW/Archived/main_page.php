...
<head>
    ...
    <title>Archived Records - Cash for work | Record Post</title>
        ...
        <div class="container-fluid row col-sm-12 p-0">
            ...
            <div class="container-fluid col-sm-12 mt-sm-0 mt-4 px-2">
                ...
                <div class="container-fluid text-center">
                    <h2 class="page-title text-center w-100">CASH FOR WORK ARCHIVED RECORDS</h2>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.view-details-btn', function() {
                ...
                const profile_type = "CASH FOR WORK";
