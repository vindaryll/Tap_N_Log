        ...
        <div class="container-fluid row col-sm-12 px-2">
            ...
            <div class="container-fluid col-sm-12 mt-sm-0 mt-4 p-0">
                <div class="container mt-3 p-0">
                    <h2 class="page-title text-center w-100">VEHICLE LOGS</h2>
                    <div class="mb-3">
                    ...
                    <div class="row d-flex justify-content-start mt-2">
                        <div class="col-md-3 col-sm-4 col-12 mb-2">
                            <button type="button" id="addRecord" class="btn btn-primary btn-custom w-100 h-100 p-2">ADD NEW VEHICLE</button>
                        </div>
                    </div>
